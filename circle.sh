  ...
  test)
    case $CIRCLE_NODE_INDEX in
      ...
      2)
        ...
        mvn site -B -pl core -Ddependency.locations.enabled=false -Dsurefire.exclude.pattern='com/fujitsu/dc/%regex[\[test\|core\/http\|core\/model\|core\odata\|core\/utils\|core\/webcontainer\]]/**' > $CIRCLE_ARTIFACTS/core-site.log
      ...
      3)
        ...
        mvn site -B -pl core -Ddependency.locations.enabled=false -Dsurefire.exclude.pattern='com/fujitsu/dc/core/%regex[\[test\|core\/rs\]]/**' > $CIRCLE_ARTIFACTS/core-site.log
