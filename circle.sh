  ...
  test)
    case $CIRCLE_NODE_INDEX in
      ...
      2)
        ...
        mvn site -B -pl core -Ddependency.locations.enabled=false -Dsurefire.exclude.pattern='com/fujitsu/dc/%regex[\[core\|test\/http\|test\odata\|test\/utils\|test\/webcontainer\]]/**' > $CIRCLE_ARTIFACTS/core-site.log
      ...
      3)
        ...
        mvn site -B -pl core -Ddependency.locations.enabled=false -Dsurefire.exclude.pattern='com/fujitsu/dc/core/%regex[\[core\|test\/rs\|test\/model\]]/**' > $CIRCLE_ARTIFACTS/core-site.log
